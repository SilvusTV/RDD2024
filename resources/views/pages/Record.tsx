  ...
  return (
    <HTML>
      <div class="flex flex-col items-center w-full h-full">
        <h1 class="text-3xl font-bold underline w-full justify-center flex mb-4 title">
        ...
        <div class={"flex gap-6"}>
          <button id="startRecord"
                  class={"text-xl p-5 bg-blue-500 rounded-xl m-4 hover:bg-blue-400 cursor-pointer"}>Lancer l'enregistrement
          </button>
          <button id="stopRecord" class={"text-xl p-5 bg-red-500 rounded-xl m-4 hover:bg-red-400 cursor-pointer"}>
